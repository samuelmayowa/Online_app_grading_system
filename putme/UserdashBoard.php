        ...
        <button type="button" class="btn btn-primary"><div class="small"><a href="photoCard.php?user=<?php echo $_SESSION['user'];  ?>" class="btn btn-primary btn-block">Re-Print PhotoCard</a></div></button>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                      <div class="small"><a href="https://putme.escohsti-edu.ng/manual-rrr-acp.php" class="btn btn-primary btn-block">Validate ACCEPTANCE FEE  Fees</a></div>
                                    ...
                                    <div class="form-row">
                                               ...
                                               <?php  }
                                                ...
                                                if($result_check ===  $regNum && $is_admission == $regNum){ ?>
                                                       <div class="small"><a href="#https://putme.escohsti-edu.ng/admissions/ChangeCourse.docx"  class="btn btn-primary btn-block">Print Change Of Course Form</a></div>
                                                    </div>
                                                </div>
                                                <?php } ?> 
                                                ...
                                                if(!empty($result_check)){
                                                if($result_check ==  $regNum  && $is_admission == $regNum) { ?>
                                                       <div class="small"><a href="https://putme.escohsti-edu.ng/admissions/notifications.php?regNum=<?php if(!empty($regNum)) { echo $regNum; } ?> &&  user=<?php echo $user; ?>"  class="btn btn-primary btn-block">Print Notification </a></div>
                                               ...
                                               <div class="small"><a href="https://putme.escohsti-edu.ng/admissions/notifications.php?regNum=<?php if(!empty($regNum)) { echo $regNum; } ?> &&  user=<?php echo $user; ?>"  class="btn btn-primary btn-block">Admission Notification Not Available</a></div>
                                                     <?php  } ?>
                                                    </div>
                                                    </div>
                                    </div>
                                    ...
                                    <div class="small"><a href="payComp.php?msg=<?php echo $_SESSION['regNum']; ?>"><button  type="button" name="compulsory" class="btn btn-primary btn-block" >Pay Compulsory Fees (#75,000)</button></a></div>
                                        ...
                                        <div class="small"><a href="https://putme.escohsti-edu.ng/logout.php" class="btn btn-primary btn-block"> >>Logout</a></div>
                                    </div>
                                    </div>
                                </div>
                            </div>
