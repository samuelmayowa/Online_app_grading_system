                                ...
                                <div class="card-header"><h3 class="text-center font-weight-light my-4" style="color:#28a745; font-family:Arial Black;"> UTME Candidates Screening / Verification </h3></div>
                                    <div class="card-body">
                                        <div class="card-header">
                                            <p>Already paid for PUTME? <a class="btn btn-primary" href="uploadverify.php">Upload Documents</a></p><h6 class="text-center font-weight-light my-4" style="color:#23c745; font-family:Arial Black;"> Verify Your Admission With Your UTME Registration Number</h6></div>
